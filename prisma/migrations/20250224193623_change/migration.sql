/*
  ...
  - The values [SYSTEM_DESIGN] on the enum `PostType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PostType_new" AS ENUM ('BLOGS', 'QUESTION', 'CHALLENGE', 'SYSTEMDESIGN');

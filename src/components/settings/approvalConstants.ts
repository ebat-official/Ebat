...
export const APPROVAL_CONSTANTS = {
	...
	EMPTY_MESSAGES: {
		NO_PENDING_POSTS: "No new posts pending approval",
		NO_PENDING_EDITS: "No post edits pending approval",
	},
...
// Column configuration for approval tables
export const approvalColumnConfig: ColumnConfig[] = [
	{
		id: "title",
		label: "Title",
...
export const approvalCategoryColumns: CategoryColumns = {
	basic: [
		"title",
		"author",
		"category",

...
function RightPanelLayout({
	...
	return (
		<div
			className={cn(
				"flex flex-col md:flex-row w-full h-full gap-2 justify-between  px-2 sm:pr-0",
				className,
			)}
		>
			{children}
...
function SidePanel({
	...
	return (
		<div className="relative ">
			...
			<div
				className={cn(
					"rightsidebar rounded-xl bg-background md:w-[340px] xl:w-[400px] self-start relative top-0 right-0 shadow-lg transition-[width,transform] duration-400", // Added transition for width

	...
	return (
		...
		>
			...
			<input
				...
				type="text"
				className={cn(
					"w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full  focus:outline-hidden focus:ring-0 pl-4 sm:pl-10 pr-20",
